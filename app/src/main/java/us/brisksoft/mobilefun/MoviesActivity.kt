...
class MoviesActivity : AppCompatActivity() {
    ...
    internal lateinit var recyclerViewAdapter: RecyclerView.Adapter<*>
    internal lateinit var recylerViewLayoutManager: RecyclerView.LayoutManager

    // 2D data array
    internal var movies = arrayOf(
        arrayOf(
            "Night of the Comet",
            "1984",
            "",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recycler_list) as RecyclerView
    ...
    inner class CustomAdapter : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
        ...
        inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            init {
                ...
                itemView.setOnClickListener {
                    ...
                    Toast.makeText(itemView.context, movies[pos][0], Toast.LENGTH_SHORT).show()
                    showMovie(pos)
                }
            }
        }
        ...
        override fun onCreateViewHolder(
            ...
            val item = layoutInflater.inflate(
                R.layout.movie_list_row_layout, parent,
                false
            )
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.mTitle.text = movies[position][0]
            holder.mDetail.text = movies[position][1]
